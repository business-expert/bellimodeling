  <form action="<?=SITE_PATH?>?cntrl=signup&act=create" method="post">
  <div class="modal-upper">
    ...
    <div class="modal-lower">
    	...
    	<div class="row">      
              ...
              <a href="<?=SITE_PATH?>?cntrl=terms-conditions&act=decline-terms">Decline Terms and Ethics Agreement ></a>
            </div>
            <div class="six columns mobile-two">
              <a href="<?=SITE_PATH?>?cntrl=signup&act=about-you"><input type="button" value="Back" class="" /></a>
