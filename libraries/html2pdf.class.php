...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(dirname(__FILE__).'/pdf/exception.class.php');
    require_once(dirname(__FILE__).'/pdf/locale.class.php');
    require_once(dirname(__FILE__).'/pdf/myPdf.class.php');
    require_once(dirname(__FILE__).'/pdf/parsingHtml.class.php');
    require_once(dirname(__FILE__).'/pdf/parsingCss.class.php');
